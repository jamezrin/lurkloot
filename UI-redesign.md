...
- There should be a minimal logo/name of the extension (the name is Streamaxxer).
...
- Another tab control or whatever to switch from the drop campaigns and "permawatch" which is just watching favorite streamers to farm points.
  - Implemented in the popup with Drops and Permawatch workflow tabs.
  ...
  - Watch time farming section should feature a scrollable and reorderable list of channels/streamers to watch. Implemented as ordered fallback streamer controls per platform in the popup.
