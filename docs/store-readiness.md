...
- It limits host permissions to Twitch pages, Twitch GQL, Twitch's public settings asset and heartbeat origins, Kick, Kick web API, and Kick WebSocket origins.
