...
policy_file="${root_dir}/streammaxxer-privacy-policy.md"
gist_id="${STREAMMAXXER_PRIVACY_GIST_ID:-24177c19981a50c0ab3aefc70e4ffdb9}"
gist_filename="${STREAMMAXXER_PRIVACY_GIST_FILENAME:-streammaxxer-privacy-policy.md}"
